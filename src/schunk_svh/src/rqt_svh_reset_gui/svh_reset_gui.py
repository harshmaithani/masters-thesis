...
class SVHResetGui(Plugin):
	...
	self._widget.finger_select_box.addItem("All",-1)
        self._widget.finger_select_box.addItem("A",0)
        self._widget.finger_select_box.addItem("B",1)
        self._widget.finger_select_box.addItem("C",2)
        self._widget.finger_select_box.addItem("D",3)
        self._widget.finger_select_box.addItem("E",4)
        self._widget.finger_select_box.addItem("F",5)
        self._widget.finger_select_box.addItem("G",6)
        self._widget.finger_select_box.addItem("H",7)
        self._widget.finger_select_box.addItem("I",8)
