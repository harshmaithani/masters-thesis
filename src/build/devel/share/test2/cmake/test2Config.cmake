...
if("TRUE" STREQUAL "TRUE")
  set(test2_SOURCE_PREFIX /home/harsh/catkin_ws/src/harsh/test2)
  set(test2_DEVEL_PREFIX /home/harsh/catkin_ws/src/build/devel)
  set(test2_INSTALL_PREFIX "")
  set(test2_PREFIX ${test2_DEVEL_PREFIX})
else()
  set(test2_SOURCE_PREFIX "")
  set(test2_DEVEL_PREFIX "")
  set(test2_INSTALL_PREFIX /usr/local)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'test2' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'harsh <harsh@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'test2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/harsh/catkin_ws/src/harsh/test2/${idir}'.  Ask the maintainer 'harsh <harsh@todo.todo>' to fix it.")
    endif()
    _list_append_unique(test2_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "image_converter")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${test2_dep}_FOUND)
      find_package(${test2_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${test2_dep} REQUIRED ${depend_list})
  endif()
