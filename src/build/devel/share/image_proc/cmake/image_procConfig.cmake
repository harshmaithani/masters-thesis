...
if("TRUE" STREQUAL "TRUE")
  set(image_proc_SOURCE_PREFIX /home/harsh/catkin_ws/src/image_pipeline/image_proc)
  set(image_proc_DEVEL_PREFIX /home/harsh/catkin_ws/src/build/devel)
...
if(NOT "/home/harsh/catkin_ws/src/build/devel/include;/home/harsh/catkin_ws/src/image_pipeline/image_proc/include;/usr/include/opencv;/usr/include" STREQUAL "")
  set(image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/harsh/catkin_ws/src/build/devel/include;/home/harsh/catkin_ws/src/image_pipeline/image_proc/include;/usr/include/opencv;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/harsh/catkin_ws/src/image_pipeline/image_proc/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
    _list_append_unique(image_proc_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "image_proc;/usr/lib/x86_64-linux-gnu/libopencv_core.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_highgui.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_imgproc.so.2.4.8")
