...
if("TRUE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/harsh/catkin_ws/src/harsh/test)
  set(test_DEVEL_PREFIX /home/harsh/catkin_ws/src/build/devel)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'harsh <harsh@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/harsh/catkin_ws/src/harsh/test/${idir}'.  Ask the maintainer 'harsh <harsh@todo.todo>' to fix it.")
    endif()
    _list_append_unique(test_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "listener")
